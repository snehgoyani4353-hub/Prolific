...
<head>
  ...
  <title>PROLIFIC | $name Workspace Portal</title>
  <meta name="description" content="Prolific Employee Workspace Portal for $name - Complete assigned tasks and submit work for review.">
...
<body class="wf-portal-body">
  ...
  <header class="wf-header">
    <div class="wf-header-left">
      <a href="index.html" class="wf-logo-link" title="Prolific Home">
        <img src="images/logo-dark.png" alt="PROLIFIC" class="wf-header-logo-img">
      </a>
      <div class="wf-brand-info">
        <span class="wf-portal-pill">SUB DESIGNER WORKSPACE</span>
        <span class="wf-engine-subtext">Enterprise Workflow Engine</span>
      </div>
    </div>

    <div class="wf-header-right">
      <a href="login.html" class="btn-back-login" title="Return to Secure Login Portal">&larr; Back to Login</a>
      <a href="index.html" class="btn-global-exit" title="Exit to Public Website">Exit to Website</a>
      <div class="user-profile-badge" id="empProfileBadge">
        <label for="empAvatarInput" class="user-avatar-upload-label" title="Click circular photo to add/change profile photo">
          <input type="file" id="empAvatarInput" accept="image/*" style="display: none;">
          <div class="user-avatar-circle" id="empAvatarCircle">
            <img src="" id="empAvatarImg" class="user-avatar-img" alt="Sub Designer Photo" style="display: none;">
            <span class="user-avatar-initials" id="empAvatarInitials">$initial</span>
            <span class="avatar-camera-icon" title="Add / Change Photo">&#128247;</span>
          </div>
        </label>
        <span id="empHeaderUserName">$name (SUB DESIGNER)</span>
      </div>
    </div>
  </header>
  ...
  <div class="wf-workspace-layout">
    ...
    <!-- LEFT SIDEBAR: PROFILE ACCORDION -->
    <aside class="wf-sidebar">
      <div class="sidebar-title">
        <span>Sub Designer Workspace</span>
      </div>

      <!-- Profile Category -->
      <div class="personnel-category">
        <div class="cat-header">
          <span>Profile (<span id="empSidebarNameCode">$name - $code</span>)</span>
        </div>
        <ul class="personnel-list" style="margin-top: 8px;">
          <li class="person-item" id="navMyProfile" style="cursor: pointer;" title="View Employee Profile Details">
            <span class="avatar-badge red-badge">ME</span>
          ...
          <li class="person-item active" id="navUrgentTasks" style="cursor: pointer;" title="View Urgent Tasks">
            ...
            <span class="name">Urgent Tasks</span>
          </li>
          ...
          <li class="person-item" id="navWorkSubmission" style="cursor: pointer;" title="Submit Work & Upload Drawings">
            <span class="avatar-badge pink-badge">&uarr;</span>
            <span class="name">Work Submission</span>
          </li>
          <li class="person-item" id="navPendingCheck" style="cursor: pointer;" title="Tasks Awaiting Manager Check">
            <span class="avatar-badge yellow-badge">&check;</span>
            <span class="name">Pending for Check</span>
          </li>
        </ul>
      </div>
    </aside>
    ...
    <main class="wf-main-content">
      ...
      <section class="wf-card-panel" id="empUrgentSection">
        <div class="wf-card-header" style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 12px;">
          <div style="display: flex; align-items: center; gap: 10px;">
            <span class="avatar-badge red-badge" style="font-size: 1rem; font-weight: 900;">!</span>
      ...
      <section class="wf-card-panel" id="empPendingSection">
        <div class="wf-card-header" style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 12px;">
          <div style="display: flex; align-items: center; gap: 10px;">
            <span class="avatar-badge blue-badge" style="font-size: 1rem; font-weight: 900;">#</span>
            <h2 id="empWorkspaceTitle" style="margin: 0;">PENDING &amp; ACTIVE ASSIGNED TASKS</h2>
          </div>
          <span style="font-size: 0.85rem; color: #64748B; font-weight: 600;">
            <span id="empWorkflowSubtext">$name's</span> active workflow. Direct workspace execution mode.
          </span>
        </div>
        ...
        <div class="emp-workspace-grid">
          ...
          <div>
            ...
            <div class="emp-guidelines-box">
              <div style="color: #1E2532; font-weight: 800; margin-bottom: 6px;">Workflow Guidelines:</div>
              <div>1. Choose your assigned project task from the dropdown above.</div>
              <div>2. Click <strong>Work on Task</strong> to focus the description editor.</div>
              <div>3. Attach CAD blueprints, site photos, or reports below.</div>
              <div>4. Click <strong>SUBMIT WORK FOR REVIEW</strong> when completed.</div>
            </div>
          </div>
          ...
          <div class="emp-sub-card">
            <div>
              <div style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 10px; flex-wrap: wrap; gap: 8px;">
                ...
                <span class="luxury-city-pill">Branch: <strong id="cardTaskTarget">$city</strong></span>
              </div>
      ...
      <section class="wf-card-panel" id="workSubmissionPanel">
        <div class="wf-card-header" style="display: flex; justify-content: space-between; align-items: center;">
          <div style="display: flex; align-items: center; gap: 10px;">
            <span class="avatar-badge pink-badge" style="font-size: 1rem; font-weight: 900;">&uarr;</span>
          ...
          <div class="emp-sub-card">
            <div>
              <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 16px;">
                ...
                <span style="font-size: 0.8rem; color: #0284C7; font-weight: 700;">Click box to upload from PC</span>
              </div>
              ...
              <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 12px; margin-bottom: 20px;">
                ...
                <div class="emp-upload-box has-file" id="boxPhoto1" onclick="document.getElementById('inputPhoto1').click();">
                  ...
                  <div style="font-size: 0.7rem; color: #047857; font-weight: 700;" id="photo1Sub">Uploaded (2.4 MB)</div>
                </div>
                ...
                <div class="emp-upload-box has-file" id="boxCAD" onclick="document.getElementById('inputCAD').click();">
                  ...
                  <div style="font-size: 0.76rem; color: #1E2532; margin-bottom: 8px; font-weight: 800;">Attach CAD</div>
                  <div style="width: 100%; height: 6px; background-color: #E2D9C8; border-radius: 3px; margin-bottom: 12px; overflow: hidden;">
                  ...
                  <div style="font-size: 0.7rem; color: #0284C7; font-weight: 700;" id="cadSub">Uploaded (18.5 MB)</div>
                </div>
                ...
                <div class="emp-upload-box has-file" id="boxReport" onclick="document.getElementById('inputReport').click();">
                  ...
                  <div style="font-size: 0.76rem; color: #1E2532; margin-bottom: 8px; font-weight: 800;">Attach Report</div>
                  <div style="width: 100%; height: 6px; background-color: #E2D9C8; border-radius: 3px; margin-bottom: 12px; overflow: hidden;">
                  ...
                  <div style="font-size: 0.7rem; color: #B45309; font-weight: 700;" id="reportSub">Uploaded (1.2 MB)</div>
                </div>
      ...
      <section class="wf-card-panel" id="empPendingCheckSection">
        <div class="wf-card-header" style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 12px;">
          <div style="display: flex; align-items: center; gap: 10px;">
            <span class="avatar-badge yellow-badge" style="font-size: 1rem; font-weight: 900;">&check;</span>
...
foreach ($emp in $employees) {
  $slug = ($emp.name.ToLower() -replace '[^a-z0-9]+', '-') + '.html'
  $content = Get-Html $emp
  $outPath = Join-Path (Get-Location) $slug
  [System.IO.File]::WriteAllText($outPath, $content, $utf8NoBom)
  Write-Host "Generated: $slug"
}

# Generate employee-dashboard.html (default to Komal)
$defaultContent = Get-Html @{ name = 'Komal'; code = 'EMP012'; work = 'Drawing'; city = 'Ahmedabad' }
[System.IO.File]::WriteAllText((Join-Path (Get-Location) "employee-dashboard.html"), $defaultContent, $utf8NoBom)
